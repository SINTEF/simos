var DMTBase = require('./DMTBase.js').DMTBase;

/*----------------------------------------------------------------------------*/
function DMTGenerator(model){
	this.constructor(model);
};
/*----------------------------------------------------------------------------*/
DMTGenerator.prototype = Object.create(DMTBase.prototype);
/*----------------------------------------------------------------------------*/
DMTGenerator.prototype.constructor = function(model) {
	DMTBase.prototype.constructor(model);
};
/*----------------------------------------------------------------------------*/
DMTGenerator.prototype.toString = function() {
	return "DMTGenerator";
};
/*----------------------------------------------------------------------------*/
DMTGenerator.prototype.generate = function(pmodel) {
	if (pmodel != undefined)
		this.setModel(pmodel.model);
	if (pmodel.dmtModel != undefined)
	   this.dmtModel = pmodel.dmtModel;
	
	var entity =  this;
	
	var cmd = [];
	
	cmd.push(JSON.stringify(this.makeDMTModel()));
...
exports.generator = new DMTGenerator();