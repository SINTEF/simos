var DSBase = require('./DSBase.js').DSBase;

/*----------------------------------------------------------------------------*/
function DSGenerator(model){
	this.constructor(model);
};
/*----------------------------------------------------------------------------*/
DSGenerator.prototype = Object.create(DSBase.prototype);
/*----------------------------------------------------------------------------*/
DSGenerator.prototype.constructor = function(model) {
	DSBase.prototype.constructor(model);
};
/*----------------------------------------------------------------------------*/
DSGenerator.prototype.toString = function() {
	return "DSGenerator";
};
/*----------------------------------------------------------------------------*/
DSGenerator.prototype.generate = function(pmodel) {
	if (pmodel != undefined)
	...
	cmd.push(JSON.stringify(this.makeSIMOSModel()));
...
exports.generator = new DSGenerator();