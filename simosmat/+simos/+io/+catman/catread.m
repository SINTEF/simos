function [a1,a2]=catread(file,sdr,machinefmt)
% CATMAN_READ
...
% 2015-11-12 LSA: sdr = 'all' reads all channels; sdr =[] returns an offset-table 
%             sdr = [channel number list] reads the specified channels
...
%p2 = ftell(fid);
fread(fid,dataoffset-ftell(fid),'uint8',machinefmt);
%p3 = ftell(fid);
